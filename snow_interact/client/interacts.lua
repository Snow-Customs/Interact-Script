...
local selected, unselected, snow_interact, pin = settings.Textures.selected, settings.Textures.unselected, settings.Textures.snow_interact, settings.Textures.pin
        ...
        if interaction then
            ...
            if GetScreenCoordFromWorldCoord(coords.x, coords.y, coords.z) then
                ...
                if isPrimary and currentAlpha < 0 then
                    ...
                    DrawSprite('interactions_txd', snow_interact, 0, 0, 0.0185, 0.03333333333333333, 0, 255, 255, 255, alpha)
                    ResetScriptGfxAlign()
